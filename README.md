...
* Download: [Stable version](https://github.com/Emil-18/reviewCursorFind/releases/download/v1.2.2/reviewCursorFind-1.2.2.nvda-addon).
...
* When the "Support all regular expressions" setting is enabeled, the add-on wil work in more situations
